//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/app/api/me/richtext-links/internal/route.ts                                              ////
//// Language: TS                                                                                                ////
//// Member actor-readable Internal Page rows for the cached rich-text picker.                                   ////
...
export async function GET(request: NextRequest): Promise<NextResponse> {
	...
	try {
		...
		console.error("[richtext-link-picker][member][internal]", error);
		const message =
