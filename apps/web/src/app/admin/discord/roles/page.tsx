//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/app/admin/discord/roles/page.tsx                                                           ////
//// Language: TSX                                                                                                 ////
...
import DiscordRolesTable from "@/components/admin/discord/DiscordRolesTable";
import { ButtonLink } from "@/components/ui/basic-elements/Button";
import { requireAdmin } from "@/lib/auth/authz";

export default async function DiscordRolesAdminPage(): Promise<JSX.Element> {
