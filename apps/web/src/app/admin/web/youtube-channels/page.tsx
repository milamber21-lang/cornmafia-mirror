//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/app/admin/web/youtube-channels/page.tsx                                                  ////
//// Language: TSX                                                                                              ////
...
import YoutubeChannelsTable from "@/components/admin/web/YoutubeChannelsTable";
import { ButtonLink } from "@/components/ui";
import { requireAdmin } from "@/lib/auth/authz";
import { listYoutubeChannelsAdmin } from "@/lib/data/youtube-channels";

export const dynamic = "force-dynamic";

export default async function YoutubeChannelsAdminPage(): Promise<JSX.Element> {
	...
	return (
		<section className="card">
			...
			<YoutubeChannelsTable initialRows={rows} />
		</section>
	);
}
