//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/app/admin/riseopedia/display-profiles/[profileId]/body-blocks/page.tsx                  ////
//// Language: TSX                                                                                              ////
//// Scoped admin page for Riseopedia display profile blocks.                                              ////
...
export default async function RiseopediaProfileBodyBlocksScopedPage({
	params,
	...
	const scopedRows = rows.bodyBlocks.filter(
		(row) => String(row.display_profile_id ?? "") === String(profileId),
	);

	return (
		<RiseopediaAdminPageChrome
			title={`Profile Blocks: ${String(profile.display_profile_name ?? profile.display_profile_code ?? profileId)}`}
