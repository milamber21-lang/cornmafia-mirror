...
export default function RiseopediaProfileElementsTable({
	initialRows,
	displayProfiles,
	meta,
	displayProfile,
	...
	return (
		<ProfileElementsTableBody
			...
			deleteConfirmMessage={(row) =>
				`Delete element ${idText(row.element_label) || idText(row.source_label)} from this profile?`
			}
			...
			columns={[
				...
				{ rowKey: "body_block_label", label: "Block" },
