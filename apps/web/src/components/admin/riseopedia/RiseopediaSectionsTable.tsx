...
export default function RiseopediaSectionsTable({ initialRows }: SectionTableProps): JSX.Element {
	return (
		<SectionsTableBody
			...
			deleteConfirmMessage={(row) => `Delete section ${idText(row.section_name)}?`}
			...
			columns={[
				...
				{ rowKey: "classification_rule_count", label: "Rules", kind: "count" },
...
export { RiseopediaSectionsTable };
...
interface SectionsTableBodyProps {
