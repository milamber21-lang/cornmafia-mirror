//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaPatchScopeOverridesTable.tsx                 ////
//// Language: TSX                                                                                               ////
//// Table-owned Riseopedia patch scope override admin list.                                         ////
...
import RiseopediaPatchScopeOverridesPanel from "./RiseopediaPatchScopeOverridesPanel";
import {
...
export interface PatchScopeOverridesProps {
	initialRows: RiseopediaAdminRows;
	meta: RiseopediaAdminMeta;
}

export default function RiseopediaPatchScopeOverridesTable({ initialRows, meta }: PatchScopeOverridesProps): JSX.Element {
	return (
		<PatchScopeOverridesTableBody
			initialRows={initialRows}
			apiPath="/api/admin/riseopedia/patch-scope-overrides"
			idKey="patch_publication_scope_override_id"
			searchPlaceholder="Search patch overrides"
			createLabel="Create override"
			deleteConfirmTitle="Delete patch override"
			deleteConfirmMessage={() => "Delete this patch override?"}
			emptyText="No patch overrides found."
			defaultSortKey="entity_type_code"
			toolbarLeft={<RiseopediaAccessControlNav active="overrides" />}
			filters={[...classificationFilters(meta), patchFilter(meta)]}
			columns={[
				{ rowKey: "entity_type_name", label: "Entity type", strong: true },
				{ rowKey: "entity_class_name", label: "Class" },
				{ rowKey: "entity_category_name", label: "Category" },
				{ rowKey: "patch_label", label: "Patch" },
				{ rowKey: "action_label", label: "Action" },
...
export { RiseopediaPatchScopeOverridesTable };
...
interface PatchScopeOverridesTableBodyProps {
...
function PatchScopeOverridesTableBody({
	initialRows,
	apiPath,
	idKey,
	columns,
	...
	renderPanel,
}: PatchScopeOverridesTableBodyProps): JSX.Element {
