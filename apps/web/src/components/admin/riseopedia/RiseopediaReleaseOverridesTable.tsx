//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaReleaseOverridesTable.tsx                    ////
//// Language: TSX                                                                                               ////
//// Table-owned Riseopedia entity release override admin list.                                      ////
...
import RiseopediaReleaseOverridesPanel from "./RiseopediaReleaseOverridesPanel";
import { buildRiseopediaReleaseOverrideFields } from "./RiseopediaAdminPanelFieldBuilders";
import { activeFilter, entityTypeFilter } from "./RiseopediaAdminConfigHelpers";
...
export interface ReleaseOverridesProps {
	initialRows: RiseopediaAdminRows;
	meta: RiseopediaAdminMeta;
}

export default function RiseopediaReleaseOverridesTable({
	initialRows,
	meta,
}: ReleaseOverridesProps): JSX.Element {
	return (
		<ReleaseOverridesTableBody
			initialRows={initialRows}
			apiPath="/api/admin/riseopedia/release-overrides"
			idKey="entity_release_override_id"
			searchPlaceholder="Search release overrides"
			createLabel="Create override"
			deleteConfirmTitle="Delete release override"
			deleteConfirmMessage={() => "Delete this entity release override?"}
			emptyText="No release overrides found."
			defaultSortKey="updated_dt"
			...
			columns={[
				...
				{ rowKey: "override_state_name", label: "Override state" },
...
export { RiseopediaReleaseOverridesTable };
...
interface ReleaseOverridesTableBodyProps {
...
function ReleaseOverridesTableBody({
	initialRows,
	apiPath,
	idKey,
	columns,
	...
	renderPanel,
}: ReleaseOverridesTableBodyProps): JSX.Element {
