//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaPatchScopeOverridesPanel.tsx                                ////
//// Language: TSX                                                                                               ////
...
export interface RiseopediaPatchScopeOverridesPanelProps {
	open: boolean;
...
export default function RiseopediaPatchScopeOverridesPanel({
	open,
	mode,
	row,
	meta,
	onClose,
	onSaved,
}: RiseopediaPatchScopeOverridesPanelProps): JSX.Element | null {
	...
	const fields = useMemo(
		() => buildRiseopediaPatchScopeOverrideFields(meta),
		[meta],
	);
	...
	return (
		<PanelForm
			...
			title={mode === "create" ? "Create patch override" : "Edit patch override"}
			width="50%"
			showSave={true}
			mode={mode}
