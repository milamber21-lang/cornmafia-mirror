//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaPatchPublicationsTable.tsx                   ////
//// Language: TSX                                                                                               ////
//// Table-owned Riseopedia patch publication admin list.                                            ////
...
import RiseopediaPatchPublicationsPanel from "./RiseopediaPatchPublicationsPanel";
import {
...
export interface PatchPublicationsProps {
	initialRows: RiseopediaAdminRows;
	channels: RiseopediaAdminRows;
	meta: RiseopediaAdminMeta;
}

export default function RiseopediaPatchPublicationsTable({ initialRows, channels, meta }: PatchPublicationsProps): JSX.Element {
	return (
		<PatchPublicationsTableBody
			initialRows={initialRows}
			apiPath="/api/admin/riseopedia/patch-publications"
			idKey="patch_publication_id"
			searchPlaceholder="Search patch publications"
			createLabel="Create publication"
			deleteConfirmTitle="Delete patch publication"
			deleteConfirmMessage={() => "Delete this patch publication?"}
			emptyText="No patch publications found."
			defaultSortKey="patch_label"
			toolbarLeft={<RiseopediaAccessControlNav active="publications" />}
			columns={[
				{ rowKey: "patch_label", label: "Patch", strong: true },
				{ rowKey: "valid_from", label: "Valid from" },
				{ rowKey: "valid_to", label: "Valid to" },
				{ rowKey: "channel_name", label: "Channel", kind: "patchChannel", actionOp: "set-stable" },
...
export { RiseopediaPatchPublicationsTable };
...
interface PatchPublicationsTableBodyProps {
...
function PatchPublicationsTableBody({
	initialRows,
	apiPath,
	idKey,
	columns,
	...
	renderPanel,
}: PatchPublicationsTableBodyProps): JSX.Element {
