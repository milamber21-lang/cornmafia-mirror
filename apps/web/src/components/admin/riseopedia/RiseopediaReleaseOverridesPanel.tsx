//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaReleaseOverridesPanel.tsx                                   ////
//// Language: TSX                                                                                               ////
...
export interface RiseopediaReleaseOverridesPanelProps {
	open: boolean;
...
export default function RiseopediaReleaseOverridesPanel({
	open,
	mode,
	row,
	meta,
	onClose,
	onSaved,
}: RiseopediaReleaseOverridesPanelProps): JSX.Element | null {
	...
	const fields = useMemo(
		() => buildRiseopediaReleaseOverrideFields(meta),
		[meta],
	);
		...
		async (values: { [key: string]: unknown }): Promise<void> => {
			...
			try {
				const response = await fetch("/api/admin/riseopedia/release-overrides", {
					...
					body: JSON.stringify({
						op: "upsert",
						id: mode === "edit" && row ? row["entity_release_override_id"] : null,
