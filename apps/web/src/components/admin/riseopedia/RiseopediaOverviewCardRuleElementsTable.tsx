...
export default function RiseopediaOverviewCardRuleElementsTable({
	initialRows,
	ruleSets,
	meta,
	ruleSet,
}: OverviewCardRuleElementsProps): JSX.Element {
	...
	return (
		<OverviewCardRuleElementsTableBody
			...
			deleteConfirmMessage={(row) =>
				`Delete element ${idText(row.display_slot_name) || idText(row.element_label) || idText(row.source_label)}?`
			}
