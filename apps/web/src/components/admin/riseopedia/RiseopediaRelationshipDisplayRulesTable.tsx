//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaRelationshipDisplayRulesTable.tsx                 ////
//// Language: TSX                                                                                               ////
//// Small-list admin table for table-driven Riseopedia relationship dependency display rules.                   ////
...
export interface RiseopediaRelationshipDisplayRulesTableProps {
	initialRows: RiseopediaAdminRows;
	meta: RiseopediaAdminMeta;
}

function optionRows(rows: RiseopediaAdminRows | undefined): RiseopediaAdminRows {
	return Array.isArray(rows) ? rows : [];
}

function activeFilter(): RiseopediaAdminFilterConfig {
	return {
		key: "active",
		rowKey: "active_flag",
		label: "Status",
...
function blockFilter(meta: RiseopediaAdminMeta): RiseopediaAdminFilterConfig {
	return {
		key: "block",
		rowKey: "dependency_block_code",
		label: "Block",
		clearLabel: "All blocks",
...
function perspectiveFilter(meta: RiseopediaAdminMeta): RiseopediaAdminFilterConfig {
	return {
		key: "perspective",
		rowKey: "perspective_code",
		label: "Perspective",
		clearLabel: "All perspectives",
...
export default function RiseopediaRelationshipDisplayRulesTable({
	initialRows,
	meta,
}: RiseopediaRelationshipDisplayRulesTableProps): JSX.Element {
	return (
		<RelationshipDisplayRulesTableBody
			initialRows={initialRows}
			apiPath="/api/admin/riseopedia/relationship-display-rules"
			idKey="rule_key"
			...
			columns={[
				{ rowKey: "relationship_name", label: "Relationship", strong: true },
				{ rowKey: "relationship_code", label: "Code" },
				{ rowKey: "perspective_name", label: "Perspective" },
				{ rowKey: "dependency_block_label", label: "Block" },
				{ rowKey: "active_flag", label: "Status", kind: "status" },
			]}
			fields={buildRiseopediaRelationshipDisplayRuleFields(meta)}
			renderPanel={({ open, mode, row, onClose, onSaved }) => (
				<RiseopediaRelationshipDisplayRulesPanel
					open={open}
					mode={mode}
					row={row}
					meta={meta}
...
interface RelationshipDisplayRulesTableBodyProps {
...
function RelationshipDisplayRulesTableBody({
	initialRows,
	apiPath,
	idKey,
	columns,
	...
	renderPanel,
}: RelationshipDisplayRulesTableBodyProps): JSX.Element {
