...
import { buildRiseopediaDisplayProfileFields } from "./RiseopediaAdminPanelFieldBuilders";
import {
	activeFilter,
	entityTypeFilter,
	idText,
...
export default function RiseopediaDisplayProfilesTable({
	initialRows,
	meta,
}: DisplayProfileTableProps): JSX.Element {
	return (
		<DisplayProfilesTableBody
			...
			deleteConfirmMessage={(row) =>
				`Delete display profile ${idText(row.display_profile_name)}?`
			}
			...
			rowActions={[
				{
					label: "Bindings",
					href: (row) =>
						`/admin/riseopedia/display-profiles/${idText(row.display_profile_id)}/bindings`,
					variant: "secondary",
				},
				{
					label: "Blocks",
					href: (row) =>
						`/admin/riseopedia/display-profiles/${idText(row.display_profile_id)}/body-blocks`,
					variant: "secondary",
				},
				{
					label: "Elements",
					href: (row) =>
						`/admin/riseopedia/display-profiles/${idText(row.display_profile_id)}/properties`,
					variant: "secondary",
				},
				{
					label: "Selectors",
					href: (row) =>
						`/admin/riseopedia/display-profiles/${idText(row.display_profile_id)}/variant-selectors`,
					variant: "secondary",
				},
			]}
			columns={[
				...
				{ rowKey: "body_renderer_name", label: "Body renderer" },
