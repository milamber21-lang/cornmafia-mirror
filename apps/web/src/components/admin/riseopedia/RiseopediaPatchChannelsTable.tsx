//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaPatchChannelsTable.tsx                       ////
//// Language: TSX                                                                                               ////
//// Table-owned Riseopedia patch publication channel admin list.                                    ////
...
import { activeFilter } from "./RiseopediaAdminConfigHelpers";
import type { RiseopediaAdminRows } from "./RiseopediaAdminTypes";
import RiseopediaPatchChannelsPanel from "./RiseopediaPatchChannelsPanel";
...
export interface RiseopediaPatchChannelsTableProps {
	initialRows: RiseopediaAdminRows;
}

export default function RiseopediaPatchChannelsTable({
	initialRows,
}: RiseopediaPatchChannelsTableProps): JSX.Element {
	return (
		<PatchChannelsTableBody
			initialRows={initialRows}
			apiPath="/api/admin/riseopedia/patch-channels"
			idKey="patch_publication_channel_id"
			searchPlaceholder="Search patch channels"
			...
			columns={[
				{ rowKey: "channel_name", label: "Name", strong: true },
				{ rowKey: "channel_code", label: "Code" },
				{ rowKey: "is_public", label: "Public", kind: "boolean" },
...
export { RiseopediaPatchChannelsTable };
...
interface PatchChannelsTableBodyProps {
...
function PatchChannelsTableBody({
	initialRows,
	apiPath,
	idKey,
	columns,
	...
	renderPanel,
}: PatchChannelsTableBodyProps): JSX.Element {
