//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/admin/riseopedia/RiseopediaProfileElementsPanel.tsx                                    ////
//// Language: TSX                                                                                               ////
...
export interface RiseopediaProfileElementsPanelProps {
	open: boolean;
...
export default function RiseopediaProfileElementsPanel({
	open,
	mode,
	row,
	displayProfiles,
	...
	return (
		<PanelForm
			...
			title={mode === "create" ? "Add profile element" : "Edit profile element"}
			width="50%"
			showSave={true}
			mode={mode}
