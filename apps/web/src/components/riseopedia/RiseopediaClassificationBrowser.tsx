//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/riseopedia/RiseopediaClassificationBrowser.tsx                              ////
//// Language: TSX                                                                                              ////
...
export default function RiseopediaClassificationBrowser({
	...
	const hasControls = showSearch || showSectionFilter || showClassFilter || showCategoryFilter;
				...
				<RiseopediaPageHeader
					...
					actions={
						<>
							...
							{matchingEntriesHref ? (
								<ButtonLink href={matchingEntriesHref} variant="neutral">
									Matching entries
								</ButtonLink>
							) : null}
						</>
