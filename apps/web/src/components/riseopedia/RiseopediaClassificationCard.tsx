//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/components/riseopedia/RiseopediaClassificationCard.tsx                                ////
//// Language: TSX                                                                                            ////
...
function RiseopediaClassificationCardMedia({
	...
	return <FallbackIcon aria-hidden className="riseopedia-classification-card__fallback-icon" strokeWidth={1.8} />;
}
	...
	return (
		<>
			<span className="riseopedia-classification-card__icon" aria-hidden>
				<RiseopediaClassificationCardMedia card={card} fallbackIcon={fallbackIcon} />
			</span>

			<span className="riseopedia-classification-card__body">
				<span className="riseopedia-classification-card__meta">{metaLabel(card)}</span>
