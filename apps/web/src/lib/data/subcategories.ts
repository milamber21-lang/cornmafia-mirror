...
function mapPolicy(
	value: "public" | "min_rank" | "equal_rank",
): "public" | "rank_at_least" | "rank_equal" {
...
function mapWritePolicy(
	value: "min_rank" | "equal_rank",
): "rank_at_least" | "rank_equal" {
	return value === "equal_rank" ? "rank_equal" : "rank_at_least";
}

function mapExplicitPolicy(
	value: "inherit" | "public" | "min_rank" | "equal_rank",
): "inherit" | "public" | "rank_at_least" | "rank_equal" {
	if (value === "inherit") {
		return "inherit";
	}
...
function mapExplicitWritePolicy(
	value: "inherit" | "min_rank" | "equal_rank",
): "inherit" | "rank_at_least" | "rank_equal" {
	if (value === "inherit") {
		return "inherit";
	}
...
export async function listSubcategoriesAdmin(): Promise<
	SubcategoryAdminItem[]
> {
