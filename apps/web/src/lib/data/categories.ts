...
function mapReadPolicy(value: CategoryAdminDbRow["read_policy_code"]): CategoryAdminItem["readPolicy"] {
  if (value === "equal_rank") {
    return "rank_equal";
  }
...
function mapWritePolicy(value: CategoryAdminDbRow["write_policy_code"]): CategoryAdminItem["writePolicy"] {
