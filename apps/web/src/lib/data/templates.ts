...
export type TemplateFieldLayoutAlignCode = "left" | "center" | "right" | "stretch";
...
function mapFieldTypeRow(row: TemplateFieldTypeAdminDbRow): TemplateFieldTypeAdminItem {
  return {
...
function mapFieldToolRow(row: TemplateFieldToolAdminDbRow): TemplateFieldToolAdminItem {
  return {
...
function mapFieldListRow(row: TemplateFieldListAdminDbRow): TemplateFieldListAdminItem {
  return {
...
function mapFieldOptionRow(row: TemplateFieldOptionAdminDbRow): TemplateFieldOptionAdminItem {
  return {
...
function mapTemplateFieldRow(row: TemplateFieldAdminDbRow): TemplateFieldAdminItem {
  return {
...
export async function findTemplateAdminById(templateId: number): Promise<TemplateAdminItem | null> {
  const result = await query<TemplateAdminDbRow>(
    `
      SELECT
        template_id,
...
export async function listTemplateFieldTypesAdmin(): Promise<TemplateFieldTypeAdminItem[]> {
...
export async function listTemplateFieldToolsAdmin(): Promise<TemplateFieldToolAdminItem[]> {
...
export async function listTemplateFieldListAdmin(): Promise<TemplateFieldListAdminItem[]> {
...
export async function findTemplateFieldListAdminById(fieldListId: number): Promise<TemplateFieldListAdminItem | null> {
  const result = await query<TemplateFieldListAdminDbRow>(
    `
      SELECT
        field_lists.field_list_id,
...
export async function listTemplateFieldOptionsAdmin(): Promise<TemplateFieldOptionAdminItem[]> {
...
export async function listTemplateFieldsAdminByTemplateId(templateId: number): Promise<TemplateFieldAdminItem[]> {
