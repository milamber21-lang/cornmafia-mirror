...
export async function findActiveMafiosopediaMediaFileById(
	mediaId: string,
): Promise<MafiosopediaMediaFile | null> {
	const result = await query<MafiosopediaMediaFileRow>(
		`SELECT media_file_id,
				...
				updated_dt
		 FROM web_view.mafiosopedia_media_files
