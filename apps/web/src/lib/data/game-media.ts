//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/lib/data/game-media.ts                                                                ////
//// Language: TS                                                                                             ////
//// DB-first public game media resolver for safe media-id app-side streaming.                                  ////
...
function mapGameMediaFileRow(row: GameMediaFileRow): GameMediaFile | null {
...
export async function findActiveGameMediaFileById(
	mediaId: string,
): Promise<GameMediaFile | null> {
	const result = await query<GameMediaFileRow>(
		`SELECT media_file_id,
				...
				updated_dt
		 FROM web_view.game_media_files
	...
	return row ? mapGameMediaFileRow(row) : null;
}
