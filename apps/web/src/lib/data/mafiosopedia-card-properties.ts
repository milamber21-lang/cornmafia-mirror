//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// FILE: apps/web/src/lib/data/mafiosopedia-card-properties.ts                                                  ////
//// Language: TS                                                                                              ////
...
export type MafiosopediaCardProperty = {
	placementCode: string;
	cardModeCode: MafiosopediaOverviewCardMode;
...
function normalizeCardMode(value: string | null): MafiosopediaOverviewCardMode {
...
export function mapMafiosopediaCardProperties(value: unknown): MafiosopediaCardProperty[] {
	...
	const rows: MafiosopediaCardProperty[] = [];
