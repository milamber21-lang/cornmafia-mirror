// FILE: apps/cms/src/collections/organization/Subcategories.ts
...
export const Subcategories: CollectionConfig = {
  slug: 'subcategories',
  admin: { useAsTitle: 'title', group: 'Organization', },
  ...
  fields: [
...

    {
      ...
      defaultValue: false,
      admin: {     
        description: 'If true, do not show this subcategory anywhere in nav pickers.' },
    },
