// FILE: apps/cms/src/collections/organization/ThemeTokens.ts
// Language: TypeScript
...
/**
 * ThemeTokens — a COLLECTION (not a global).
 * Slug: themeTokens
 * Used as a relationship target from iconColorField(...) across the schema.
 */
