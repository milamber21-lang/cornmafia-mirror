// FILE: apps/cms/src/collections/access/DiscordUsers.ts
// Language: TypeScript
...
export const DiscordUsers: CollectionConfig = {
  ...
  fields: [
    ...
    // NOTE: Removed the legacy Wallets relationship that pointed to the deleted 'wallets' collection.
    // If/when you add wallet linking later, we’ll add a safe replacement (e.g., array of addresses).
